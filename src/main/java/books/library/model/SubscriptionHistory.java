...
@Entity
public class SubscriptionHistory extends Model {
...
//    }
    ...
    public SubscriptionHistory(Subscription subscription){
        setBook(subscription.getBook());
        setDate_return(subscription.getDate_return());
        setId(subscription.getId());
        setReader(subscription.getReader());
    }
